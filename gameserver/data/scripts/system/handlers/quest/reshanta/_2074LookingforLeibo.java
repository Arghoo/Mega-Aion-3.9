				...
				case 203550: { // Munin
					switch (dialog) {
						...
						case STEP_TO_2: {
							...
							TeleportService2.teleportTo(player, 120010000, 1403.2668f, 1052.4296f, 206.088f, (byte) 89, TeleportAnimation.BEAM_ANIMATION);
							return closeDialogWindow(env);
						}
					}
					break;
				...
				case 204207: { // Kasir
					switch (dialog) {
						...
						case STEP_TO_3: {
							...
							TeleportService2.teleportTo(player, 120010000, 967.88196f, 1210.8297f, 201.50243f, (byte) 15, TeleportAnimation.BEAM_ANIMATION);
							return closeDialogWindow(env);
						}
					}
					break;
