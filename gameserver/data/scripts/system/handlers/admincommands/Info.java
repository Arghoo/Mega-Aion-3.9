		...
		if (target instanceof Player) {
			...
			PacketSendUtility.sendMessage(admin,
				"[Info about target]" + "\nName: " + npc.getName() + "\nId: " + npc.getNpcId() + " / ObjectId: " + admin.getTarget().getObjectId() + " / StaticId: " + npc.getSpawn().getStaticId() + "\nMap ID: " + admin.getTarget().getWorldId()
					+ "\nX: " + admin.getTarget().getX() + " / Y: " + admin.getTarget().getY() + " / Z: " + admin.getTarget().getZ() + " / Heading: " + admin.getTarget().getHeading() + " / Angle: " + PositionUtil.getAngleToTarget(admin,
			...
			PacketSendUtility.sendMessage(admin,
				"[Sense range]" + "\nRadius: " + npc.getObjectTemplate().getAggroRange() + "\nSide: " + npc.getObjectTemplate().getBoundRadius().getSide() + " / Front: " + npc.getObjectTemplate().getBoundRadius().getFront() + "\nDirectional bound: "
					+ PositionUtil.getDirectionalBound(npc, admin, true) + "\nDistance: " + (npc.getObjectTemplate().getAggroRange() + PositionUtil.getDirectionalBound(npc, admin, true)) + "\nCollision: " + (npc.getObjectTemplate().getAggroRange()
					- npc.getCollision()));
			int asmoDmg = 0;
			int elyDmg = 0;
			...
			PacketSendUtility.sendMessage(admin,
				"[Info about gather]\n" + "Name: " + gather.getName() + "\nId: " + gather.getObjectTemplate().getTemplateId() + " / ObjectId: " + admin.getTarget().getObjectId() + "\nMap ID: " + admin.getTarget().getWorldId() + "\nX: "
					+ admin.getTarget().getX() + " / Y: " + admin.getTarget().getY() + " / Z: " + admin.getTarget().getZ() + " / Heading: " + admin.getTarget().getHeading());
		}
	}
