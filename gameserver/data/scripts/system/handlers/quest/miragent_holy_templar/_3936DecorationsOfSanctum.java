				...
				case 203710:
					switch (dialog) {
						...
						case CHECK_COLLECTED_ITEMS:
							...
							if (itemCount1 >= 5 && itemCount2 >= 5 && itemCount3 >= 5 && itemCount4 >= 5) {
								removeQuestItem(env, 182206091, 5);
								removeQuestItem(env, 182206092, 5);
								removeQuestItem(env, 182206093, 5);
								removeQuestItem(env, 182206094, 5);
