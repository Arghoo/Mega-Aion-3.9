...
public class ShutdownHandler extends TaskFromDBHandler
{
	...
	public void trigger()
	{
		...
		ThreadPoolManager.getInstance().schedule(() -> ShutdownHook.getInstance().doShutdown(countDown, announceInterval, ShutdownHook.ShutdownMode.SHUTDOWN), warnCountDown * 1000);
	}
}
