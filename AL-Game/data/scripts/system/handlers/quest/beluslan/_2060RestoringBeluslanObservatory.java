				...
				case 204701: { // Hod
					switch (dialog) {
						...
						case STEP_TO_1: {
							...
							TeleportService2.teleportTo(player, 220040000, 1878.5059f, 2237.2764f, 649.65295f, (byte) 56, TeleportAnimation.BEAM_ANIMATION);
				...
				case 204785: { // Gwendolin
					switch (dialog) {
						...
						case STEP_TO_2: {
							...
							TeleportService2.teleportTo(player, 400010000, 937.9075f, 2999.8052f, 1646.3984f, (byte) 41, TeleportAnimation.BEAM_ANIMATION);
							return closeDialogWindow(env);
						}
						case STEP_TO_5: {
				...
				case 278003: { // Hisui
					switch (dialog) {
						...
						case STEP_TO_3: {
							...
							TeleportService2.teleportTo(player, 400010000, 1180.695f, 1957.6768f, 1604.9427f, (byte) 20, TeleportAnimation.BEAM_ANIMATION);
							return closeDialogWindow(env);
						}
					}
					break;
