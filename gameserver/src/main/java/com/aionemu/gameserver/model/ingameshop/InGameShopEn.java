					...
					if (result == 1) {
						...
						if (request.gift) {
							...
							if (LoggingConfig.LOG_INGAMESHOP_SQL)
								InGameShopLogDAO.log("GIFT", new Timestamp(System.currentTimeMillis()), player.getName(), player.getAcountName(), request.receiver, item.getItemId(), item.getItemCount(), item.getItemPrice());
						} else {
							...
							if (LoggingConfig.LOG_INGAMESHOP_SQL)
								InGameShopLogDAO.log("BUY", new Timestamp(System.currentTimeMillis()), player.getName(), player.getAcountName(), player.getName(), item.getItemId(), item.getItemCount(), item.getItemPrice());
