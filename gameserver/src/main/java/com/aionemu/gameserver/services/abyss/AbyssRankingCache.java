...
public class AbyssRankingCache
{
	...
	public void reloadRankings()
	{
		...
		AbyssRankDAO.updateRankList(RankingConfig.TOP_RANKING_MAX_OFFLINE_DAYS);
	...
	private void renewLegionRanking()
	{
		...
		ArrayList<AbyssRankingResult> elyosRanking = AbyssRankDAO.getAbyssRankingLegions(Race.ELYOS), asmoRanking = AbyssRankDAO.getAbyssRankingLegions(Race.ASMODIANS);
	...
	private List<SM_ABYSS_RANKING_PLAYERS> generatePacketsForRace(Race race)
	{
		...
		ArrayList<AbyssRankingResult> list = AbyssRankDAO.getAbyssRankingPlayers(race, RankingConfig.TOP_RANKING_MAX_OFFLINE_DAYS);
		int page = 1;
