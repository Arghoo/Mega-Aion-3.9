...
public class CM_MOVE extends AionClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((type & MovementMask.STARTMOVE) == MovementMask.STARTMOVE || type == 0) {
			player.getKnownList().doOnAllPlayers(observer -> {
	...
	{
		return "CM_MOVE [type=" + type + ", heading=" + heading + ", x=" + x + ", y=" + y + ", z=" + z + ", x2=" + x2 + ", y2=" + y2 + ", z2=" + z2 + ", vehicleX=" + vehicleX + ", vehicleY=" + vehicleY + ", vehicleZ=" + vehicleZ + ", vectorX="
			+ vectorX + ", vectorY=" + vectorY + ", vectorZ=" + vectorZ + ", glideFlag=" + glideFlag + ", unk1=" + unk1 + ", unk2=" + unk2 + "]";
	}
}
