...
public class _1062IndratuLegion extends QuestHandler
{
	...
	public boolean onKillEvent(QuestEnv env)
	{
		...
		if (targetId == 700220 && qs.getQuestVarById(0) == 12) {
			...
			ThreadPoolManager.getInstance().schedule(() -> QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 212588, npc.getX(), npc.getY(), npc.getZ(), npc.getHeading()), 3000);
			return true;
		}
