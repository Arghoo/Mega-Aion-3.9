...
public class ConvertHealEffect extends ShieldEffect
{
	...
	public void startEffect(final Effect effect)
	{
		...
		AttackShieldObserver asObserver = new AttackShieldObserver(hitValueWithDelta, valueWithDelta, percent, hitPercent, effect, hitType, this.getType(), this.hitTypeProb, 0, 0, type, 0);
