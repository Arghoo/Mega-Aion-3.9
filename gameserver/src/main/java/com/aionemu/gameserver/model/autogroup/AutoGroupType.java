...
{
	BARANATH_DREDGION(1, 600000, 8) { @Override AutoInstance newAutoInstance() { return new AutoDredgionInstance(); } },
	CHANTRA_DREDGION(2, 600000, 8) { @Override AutoInstance newAutoInstance() { return new AutoDredgionInstance(); } },
	TERATH_DREDGION(3, 600000, 8) { @Override AutoInstance newAutoInstance() { return new AutoDredgionInstance(); } },
