...
public class _1020SealingTheAbyssGate extends QuestHandler
{
	...
	public boolean onMovieEndEvent(QuestEnv env, int movieId)
	{
		if (movieId == 153) {
			...
			TeleportService2.teleportTo(env.getPlayer(), 210030000, 1722.1472f, 1493.8146f, 121.7286f, (byte) 119, TeleportAnimation.BEAM_ANIMATION);
			return true;
		}
		return false;
	}
