...
public class NpcController extends CreatureController<Npc>
{
	...
	public void doReward()
	{
		...
		for (AggroInfo info : finalList) {
			...
			if (percentage > 1) {
				log.warn("WARN BIG REWARD PERCENTAGE: " + percentage + " damage: " + info.getDamage() + " total damage: " + totalDmg + " name: " + info.getAttacker().getName() + " obj: " + info.getAttacker().getObjectId() + " owner: "
					+ getOwner().getName() + " player was skiped");
				continue;
			}
