				...
				case 203752: { // Jucleas
					switch (dialog) {
						...
						case STEP_TO_1: {
							...
							TeleportService2.teleportTo(player, 110010000, 1826.7903f, 2182.743f, 528.5118f, (byte) 119, TeleportAnimation.BEAM_ANIMATION);
				...
				case 203852: { // Ludina
					switch (dialog) {
						...
						case STEP_TO_2: {
							...
							TeleportService2.teleportTo(player, 210030000, 2315.2952f, 1798.3674f, 195.26416f, (byte) 34, TeleportAnimation.BEAM_ANIMATION);
							return closeDialogWindow(env);
						}
					}
					break;
				...
				case 203164: { // Morai
					switch (dialog) {
						...
						case STEP_TO_7: {
							...
							TeleportService2.teleportTo(player, 110010000, 1875.6426f, 1513.8203f, 812.6755f, (byte) 0, TeleportAnimation.BEAM_ANIMATION);
							return closeDialogWindow(env);
						}
					}
					break;
					...
					switch (dialog) {
						...
						case SELECT_ACTION_2720: {
							if (var == 96) {
								...
								QuestService.addNewSpawn(310070000, player.getInstanceId(), 212992, (float) 191.9, (float) 267.68, (float) 1374, (byte) 0);
				...
				case 203701: { // Lavirintos
					switch (dialog) {
						...
						case STEP_TO_8: {
							...
							TeleportService2.teleportTo(player, 110010000, 1874.8026f, 1485.928f, 805.5178f, (byte) 118, TeleportAnimation.BEAM_ANIMATION);
							return closeDialogWindow(env);
						}
					}
				}
