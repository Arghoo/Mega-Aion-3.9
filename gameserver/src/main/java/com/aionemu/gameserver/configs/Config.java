...
public class Config
{
	...
	public static void load()
	{
		try {
			...
			ConfigurableProcessor.process(AbyssConfig.class, mainProps);
			log.info("Loading: " + main + "/abyss.properties");

			ConfigurableProcessor.process(AIConfig.class, mainProps);
			log.info("Loading: " + main + "/ai.properties");

			ConfigurableProcessor.process(ArenaScheduleConfig.class, mainProps);
			log.info("Loading: " + main + "/arenaschedule.properties");
			...
			ConfigurableProcessor.process(TimingsConfig.class, mainProps);
			log.info("Loading: " + main + "/timings.properties");
	...
	public static void reload()
	{
		try {
			...
			ConfigurableProcessor.process(AbyssConfig.class, mainProps);
			log.info("Reload: " + main + "/abyss.properties");

			ConfigurableProcessor.process(AIConfig.class, mainProps);
			log.info("Reload: " + main + "/ai.properties");

			ConfigurableProcessor.process(ArenaScheduleConfig.class, mainProps);
			log.info("Reload: " + main + "/arenaschedule.properties");
			...
			ConfigurableProcessor.process(TimingsConfig.class, mainProps);
			log.info("Reload: " + main + "/timings.properties");
