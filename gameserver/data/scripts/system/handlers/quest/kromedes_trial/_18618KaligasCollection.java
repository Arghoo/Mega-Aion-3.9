...
public class _18618KaligasCollection extends QuestHandler
{
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		if (targetId == 730326) {
			...
			if ((playerClass == PlayerClass.RANGER || playerClass == PlayerClass.ASSASSIN || playerClass == PlayerClass.MAGE || playerClass == PlayerClass.PRIEST || playerClass == PlayerClass.GLADIATOR || playerClass == PlayerClass.TEMPLAR
