...
public class Npc extends Creature
{
	...
	public boolean guardAgainst(Npc npc)
	{
		...
		if (this.getRace() == npc.getRace())
			return false;
		if ((getTribe().isLightGuard() || this.getRace() == Race.ELYOS && this.getObjectTemplate().getNpcTemplateType() == NpcTemplateType.GUARD) && DataManager.TRIBE_RELATIONS_DATA.isAggressiveRelation(npc.getTribe(), TribeClass.PC))
			return true;
		if ((getTribe().isDarkGuard() || this.getRace() == Race.ASMODIANS && this.getObjectTemplate().getNpcTemplateType() == NpcTemplateType.GUARD) && DataManager.TRIBE_RELATIONS_DATA.isAggressiveRelation(npc.getTribe(), TribeClass.PC_DARK))
			return true;
		return false;
	}
