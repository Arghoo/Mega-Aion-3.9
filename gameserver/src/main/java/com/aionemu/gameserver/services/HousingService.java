...
public class HousingService
{
	...
	private HousingService()
	{
		...
		customHouses = new ConcurrentHashMap<Integer, House>(HousesDAO.loadHouses(DataManager.HOUSE_DATA.getLands(), false));
		studios = new ConcurrentHashMap<Integer, House>(HousesDAO.loadHouses(DataManager.HOUSE_DATA.getLands(), true));
	...
	public void switchHouseBuilding(House currentHouse, int newBuildingId)
	{
		...
		HousesDAO.storeHouse(currentHouse);
