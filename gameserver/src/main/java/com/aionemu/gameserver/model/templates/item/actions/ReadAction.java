...
public class ReadAction extends AbstractItemAction
{
	...
	public void act(final Player player, Item parentItem, Item targetItem)
	{
		...
		ThreadPoolManager.getInstance().schedule(() -> PacketSendUtility.broadcastPacket(player, new SM_ITEM_USAGE_ANIMATION(player.getObjectId(), itemObjId, id, 0, 1, 0), true), 50);
	}
}
