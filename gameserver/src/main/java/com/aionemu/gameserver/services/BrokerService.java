...
public class BrokerService
{
	...
	public void buyBrokerItem(Player player, int itemUniqueId)
	{
		...
		if (LoggingConfig.LOG_BROKER_EXCHANGE)
			log.info(
				"[BROKER EXCHANGE] > [Player: " + player.getName() + "] bought [Item: " + buyingItem.getItemId() + "] " + "[Count: " + buyingItem.getItemCount() + (LoggingConfig.ENABLE_ADVANCED_LOGGING ? "] [Item Name: " + item.getItemName() : "]")
