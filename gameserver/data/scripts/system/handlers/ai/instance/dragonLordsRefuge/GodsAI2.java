...
public class GodsAI2 extends AggressiveNpcAI2
{
	...
	protected void handleSpawned()
	{
		...
		if (getNpcId() == 219564 || getNpcId() == 219567) {
			...
			ThreadPoolManager.getInstance().schedule(() -> SkillEngine.getInstance().getSkill(getOwner(), (getOwner().getNpcId() == 219564 ? 20932 : 20936), 100, getOwner()).useSkill(), 8000);
			...
			ThreadPoolManager.getInstance().schedule(() -> SkillEngine.getInstance().getSkill(getOwner(), (getNpcId() == 219565 ? 20929 : 20933), 100, tiamat).useNoAnimationSkill(), 2000);
		}
	}
