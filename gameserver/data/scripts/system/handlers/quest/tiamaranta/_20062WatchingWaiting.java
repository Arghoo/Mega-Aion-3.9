		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 2) {
				if (player.isInsideZone(item.getItemTemplate().getUseArea())) {
					...
					Npc npc1 = (Npc) QuestService.spawnQuestNpc(player.getWorldId(), player.getInstanceId(), 218822, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ(), player.getPosition().getHeading());
					Npc npc2 = (Npc) QuestService.spawnQuestNpc(player.getWorldId(), player.getInstanceId(), 218822, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ(), player.getPosition().getHeading());
