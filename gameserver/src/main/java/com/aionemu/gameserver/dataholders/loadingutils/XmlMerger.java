...
public class XmlMerger
{
	 ...
	 * @throws IOException        if the destination file exists but is a directory rather than a regular file, does not exist but cannot
	 ...
	 * @throws FileNotFoundException if the reading file does not exist, is a directory rather than a regular file, or for some other reason
