...
public class AbyssalSplinterInstance extends GeneralInstanceHandler
{
	...
	public void onDie(Npc npc)
	{
		...
		switch (npcId) {
			...
			case 216949:  //ebonsoul
				...
				if (ebonsoul == null || ebonsoul.getLifeStats().isAlreadyDead() && rukril == null || rukril.getLifeStats().isAlreadyDead()) {
				...
				break;
			case 281907: {
				Npc ebonsoulBoss = getNpc(216949);
				if (ebonsoulBoss != null && !ebonsoulBoss.getLifeStats().isAlreadyDead()) {
					if (MathUtil.isIn3dRange(npc, ebonsoulBoss, 5)) {
						ebonsoulBoss.getEffectController().removeEffect(19159);
			...
			case 281908: {
				Npc rukrilBoss = getNpc(216948);
				if (rukrilBoss != null && !rukrilBoss.getLifeStats().isAlreadyDead()) {
					if (MathUtil.isIn3dRange(npc, rukrilBoss, 5)) {
						rukrilBoss.getEffectController().removeEffect(19266);
			...
			case 216952: // Yamennes Blindsight
				...
				// spawnYamennesAbyssalTreasureBox(700938);
	...
	{
		spawn(700935, 649.24286f, 361.33755f, 467.89145f, (byte) 33);
	}

	private void spawnPazuzusTreasureBox()
	{
		if (Rnd.get(0, 100) >= 80) { // 20% chance, not retail
			spawn(700935, 649.243f, 362.338f, 466.0451f, (byte) 0);
		}
	}
	...
	private void spawnDayshadeAbyssalTreasureChest()
	{
		...
		spawn(700935, 404.891f, 650.2943f, 439.2548f, (byte) 130);
	}
	...
	private void removeSummoned()
	{
		...
		if ((gate1 == null || gate1.getLifeStats().isAlreadyDead()) && (gate2 == null || gate2.getLifeStats().isAlreadyDead()) && (gate3 == null || gate3.getLifeStats().isAlreadyDead())) {
