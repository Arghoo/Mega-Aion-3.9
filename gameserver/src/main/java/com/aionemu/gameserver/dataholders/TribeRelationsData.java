...
public class TribeRelationsData
{
	...
	public boolean isFriendlyRelation(TribeClass tribeName1, TribeClass tribeName2)
	{
		...
		if (tribe1 == null || tribe2 == null)
			return false;
		return tribe1.getFriend().contains(tribeName2) || tribe2.isBasic() && tribe1.getFriend().contains(tribe2.getBase()) || !tribe2.isBasic() && tribe1.getBase().equals(tribe2.getBase());
	}
