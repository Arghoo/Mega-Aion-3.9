...
public class PlayerEventService
{
	...
	private PlayerEventService()
	{
		...
		ThreadPoolManager.getInstance().scheduleAtFixedRate(() -> World.getInstance().doOnAllPlayers(visitor), EventsConfig.EVENT_PERIOD * 60000, EventsConfig.EVENT_PERIOD * 60000);
	}
