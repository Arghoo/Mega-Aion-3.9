...
public class DredgionInstance2 extends GeneralInstanceHandler
{
	...
	protected void startInstanceTask()
	{
		...
		instanceTask = ThreadPoolManager.getInstance().schedule(() -> stopInstance(dredgionReward.getWinningRaceByScore()), 2520000);
	}
	...
	private void addKillToPlayer(Player player)
	{
