		...
		if (targetId == 203704) {
			...
			switch (env.getDialog()) {
				...
				case STEP_TO_10:
					...
					// TeleportService2.teleportTo(player, 310100000, 582.09f, 509.02f, 1186.47f, (byte) 119, TeleportAnimation.BEAM_ANIMATION);
					return true;
				case SET_REWARD:
					if (var == 6) {
			...
			switch (env.getDialog()) {
				...
				case STEP_TO_11:
					...
					// TeleportService2.teleportTo(player, 310100000, 474.19f, 429.22f, 1062.006f, (byte) 102, TeleportAnimation.BEAM_ANIMATION);
					return true;
			}
		}
		return false;
