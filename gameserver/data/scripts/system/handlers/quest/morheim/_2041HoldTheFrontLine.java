...
public class _2041HoldTheFrontLine extends QuestHandler
{
	...
	private final static int[] mobIds = { 280818, 211624 };
			...
			switch (targetId) {
				case 204301: { // Aegir
					switch (env.getDialog()) {
						...
						case STEP_TO_1:
							...
							TeleportService2.teleportTo(player, 220020000, 2796.2876f, 478.0224f, 265.3266f, (byte) 48, TeleportAnimation.BEAM_ANIMATION);
				...
				case 204403: { // Taisan
					switch (env.getDialog()) {
						...
						case STEP_TO_2:
							...
							TeleportService2.teleportTo(player, 220020000, 3028.44f, 872.4483f, 362.875f, (byte) 15, TeleportAnimation.BEAM_ANIMATION);
							return closeDialogWindow(env);
					}
					break;
				}
				case 204432: { // Kargate
					switch (env.getDialog()) {
						...
						case STEP_TO_4:
							if (var == 4) {
								TeleportService2.teleportTo(player, 220020000, 229.18861f, 2412.7903f, 453.9792f, (byte) 48, TeleportAnimation.BEAM_ANIMATION);
