...
public class RestartHandler extends TaskFromDBHandler
{
	...
	public void trigger()
	{
		...
		ThreadPoolManager.getInstance().schedule(() -> ShutdownHook.getInstance().doShutdown(countDown, announceInterval, ShutdownHook.ShutdownMode.RESTART), warnCountDown * 1000);
	}
}
