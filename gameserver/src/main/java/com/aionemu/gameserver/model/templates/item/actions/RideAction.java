...
public class RideAction extends AbstractItemAction
{
	...
	public void act(final Player player, final Item parentItem, Item targetItem)
	{
		...
		PacketSendUtility.broadcastPacket(player, new SM_ITEM_USAGE_ANIMATION(player.getObjectId(), parentItem.getObjectId(), parentItem.getItemId(), TimingsConfig.RIDING_SPEED, 0, 0), true);
